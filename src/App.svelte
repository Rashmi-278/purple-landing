      ...
      <nav class="navbar navbar-expand-lg fixed-top navbar-transparent " color-on-scroll="100">
        <div class="container">
          <div class="navbar-translate">
            <a class="navbar-brand" href="/" rel="tooltip" title="Inari" data-placement="bottom" >
              <span>Inari</span>
            </a>
          ...
          <div class="collapse navbar-collapse justify-content-end" id="navigation">
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item p-0">
                <a class="nav-link" rel="tooltip" title="Follow us on Instagram" data-placement="bottom" href="https://discord.gg/znrEDDQca8" target="_blank">
              ...
              <div class="container">
                <div class="title">
                  <hr class="line-info">
                   ...
                   <div class="image-holder">
                    <img alt="logo" src="./assets/img/part2.jpeg">
                  </div>
                </div>
              ...
              <div class="container">
                <div class="title">
                  <hr class="line-info">
                   ...
                   <div class="image-holder">
                    <img alt="Fundraising" src="./assets/img/sec2.jpeg">
                  </div>
                </div>
              ...
              <div class="container">
                <div class="title">
                  <hr class="line-info">
                   ...
                   <div class="image-holder">
                    <img alt="DAO" src="./assets/img/part3.jpeg">
                  </div>
                </div>
